...
switch nlp.Plant.Name
    case 'RightStance'
        H_W1 = nlp.Plant.ContactPoints.RightSole.computeForwardKinematics;
        H_W2 = nlp.Plant.ContactPoints.LeftSole.computeForwardKinematics;
        
    case 'LeftStance'
        H_W1 = nlp.Plant.ContactPoints.LeftSole.computeForwardKinematics;
        H_W2 = nlp.Plant.ContactPoints.RightSole.computeForwardKinematics;
