function [conGUI] = cassie_load_animation(robot, gait, terrain, varargin)
    ...
    right_toe_anim_frame = CoordinateFrame(...
         'Name','RightToeAnim',...
         'Reference',robot.ContactPoints.RightSole,...
         'Offset',[0,0,0],...
         'R',[0,0,pi/2]);
    top_offset = [0,0,0.05];
    wf = 0.05; % toe width
    ...
    left_toe_anim_frame = CoordinateFrame(...
         'Name','LeftToeAnim',...
         'Reference',robot.ContactPoints.LeftSole,...
         'Offset',[0,0,0],...
         'R',[0,0,pi/2]);
    top_offset = [0,0,0.05];
    wf = 0.05; % toe width
